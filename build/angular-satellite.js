    ...
    .factory('nsTwoLineElementFactory', [
        function () {
            ...
            function TwoLineElement(tleString) {
                 ...
                 */
                this.loadTLE = function _loadTLE(tleString) {
                ...
                if (angular.isDefined(tleString) && !angular.isString(tleString)) {
                    throw 'TwoLineElement: constructor tleString must be a string or null'
                }

                // Initialize with provided TLE
                _loadTLE(tleString);
            }
...
angular.module('angular-satellite', ['angular-satellite.nsTwoLineElementFactory'])

    .factory('nsSatellite', function (nsTwoLineElementFactory) {
